...
def _generate_image_and_label_batch(image, label, min_queue_examples,
  ...
  """
    ...
    return images, tf.one_hot(tf.reshape(label_batch, [batch_size]), numClasses, 1, 0, axis = -1)


def getDistortedInputs(data_dir, batch_size, numClasses):
...
def getInputs(eval_data, data_dir, batch_size, numClasses):
